...
public class SvgView extends View implements SvgUtils.AnimationStepListener {
  ...
  @Override protected void onSizeChanged(final int w, final int h, int oldw, int oldh) {
  ...
  public static class AnimatorBuilder {
     ...
     * Default constructor.
     *
     * @param SvgView The view that must be animated.
     */
  ...
  @Override public void onAnimationStep() {
    invalidate();
  }
