...
public class VerticalScrollViewActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    scroll_text_view.setLeftImageVisibility(View.VISIBLE);
    scroll_text_view.setRightMoreVisibility(View.VISIBLE);
    scroll_text_view.setViewClickListener(new VerticalScrollTextViewListener() {
      @Override
      public void onContentClick(ScrollTextDataBean bean) {
        Toast.makeText(VerticalScrollViewActivity.this, bean.contentTitle + ":" + bean.contentDesc, Toast.LENGTH_SHORT).show();
      }
